...
open class SecureTextToggleButton: UIButton {
    ...
    open var showSecureTextImage:UIImage = UIImage(named: "visibility_on")!{
...
//    open var hideSecureTextImage:UIImage = UIImage(named: "visibility_off", in:BundleUtil.bundle, compatibleWith: nil)!
    open var hideSecureTextImage:UIImage = UIImage(named: "visibility_off")!
    ...
    /**
     ...
     - returns:
     */
    //UIImage(named: "visibility_on", in:BundleUtil.bundle, compatibleWith: nil)!
    //UIImage(named: "visibility_off", in: BundleUtil.bundle, compatibleWith: nil)
    public convenience init(showSecureTextImage:UIImage = UIImage(named:"visibility_on")! , hideSecureTextImage:UIImage = UIImage(named:"visibility_off")! , imageTint:UIColor = UIColor.gray)
    {
